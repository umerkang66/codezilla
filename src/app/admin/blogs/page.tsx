...
export const metadata = {
  title: "Blogs Management | Codzilla Admin Panel",
  description: "Manage, write, and edit blog posts for Codzilla Technologies website.",
};
  ...
  return (
    <main className="h-screen max-h-screen w-screen overflow-hidden bg-[#111111] text-[#E1E6EB] flex font-sans select-none">
      ...
      <div className="flex-1 flex flex-col h-full overflow-hidden bg-[#111111]">
        ...
        {/* Blogs Management Workspace */}
        <AdminBlogsManagement initialBlogs={blogs || []} userFullName={fullName} />
      </div>
    </main>
  );
}
