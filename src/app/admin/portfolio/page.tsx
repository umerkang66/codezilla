...
export const metadata = {
  title: "Portfolio & Case Studies | Codzilla Admin Panel",
  description: "Manage, add, edit, and delete portfolio projects and engineering case studies.",
};
  ...
  return (
    <main className="h-screen max-h-screen w-screen overflow-hidden bg-[#111111] text-[#E1E6EB] flex font-sans select-none">
      ...
      <div className="flex-1 flex flex-col h-full overflow-hidden bg-[#111111]">
        ...
        <AdminPortfolioManagement initialProjects={projects || []} />
      </div>
    </main>
  );
}
