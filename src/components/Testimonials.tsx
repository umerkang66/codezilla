  ...
  return (
    <section id="testimonials" className="py-20 bg-[#0D0D0D] border-t border-b border-[#E1E6EB]/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Loading state */}
        {loading ? (
          <div className="p-16 text-center bg-[#1A1A1A] border border-[#E1E6EB]/10 flex flex-col items-center justify-center space-y-3 rounded-none">
