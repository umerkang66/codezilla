  ...
  return (
    <section id="cta-banner" className="py-16 bg-[#1A1A1A] border-t border-b border-[#E1E6EB]/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-[#111111] border border-[#81D607]/40 p-8 sm:p-12 text-center flex flex-col items-center justify-center space-y-6 rounded-none">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#1A1A1A] text-[#81D607] text-xs font-semibold uppercase tracking-wider rounded-none">
          ...
          <div className="pt-2">
            <a
              href="#contact"
              className="inline-flex items-center gap-3 px-8 py-4 font-bold text-sm text-[#111111] bg-[#81D607] hover:bg-[#72BE06] transition-all duration-200 rounded-none"
              id="cta-banner-btn"
            >
