      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {badges.map((badge, idx) => (
            <div
              key={idx}
              className="p-5 bg-[#1A1A1A] border border-[#E1E6EB]/10 flex items-center gap-4 hover:border-[#81D607]/60 transition-colors rounded-none"
            >
              <div className="w-10 h-10 bg-[#111111] border border-[#81D607]/40 flex items-center justify-center text-[#81D607] shrink-0 rounded-none">
