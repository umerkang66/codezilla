...
export default function Hero() {
  return (
    <section id="hero" className="relative z-10 w-full overflow-hidden pt-28 sm:pt-36 pb-16 lg:pb-24">
      {/* Background Topography Animation matching theme colors */}
      <div className="absolute inset-0 z-0 pointer-events-auto opacity-50 sm:opacity-60">
        <Topography
          lowColor="#1A3803"
          midColor="#81D607"
          highColor="#E1E6EB"
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 text-left space-y-5 sm:space-y-6">
            <div className="inline-flex items-center gap-2 px-3 sm:px-3.5 py-1.5 bg-[#1A1A1A]/90 border border-[#81D607]/40 text-[#81D607] text-[10px] sm:text-xs font-semibold uppercase tracking-wider rounded-none max-w-full overflow-hidden truncate backdrop-blur-xs">
            ...
            <div className="pt-2 flex flex-col sm:flex-row items-stretch sm:items-center gap-3.5 sm:gap-4">
              ...
              <a
                href="#services"
                className="inline-flex items-center justify-center gap-2 px-6 sm:px-7 py-3.5 font-semibold text-xs sm:text-sm text-[#E1E6EB] bg-[#1A1A1A]/90 hover:bg-[#262626] border border-[#E1E6EB]/15 hover:border-[#81D607]/60 transition-colors rounded-none w-full sm:w-auto text-center backdrop-blur-xs"
            ...
            <div className="pt-5 border-t border-[#E1E6EB]/10 grid grid-cols-3 gap-2 sm:gap-4 text-left">
              <div className="p-2 sm:p-3 bg-[#1A1A1A]/80 border border-[#E1E6EB]/10 backdrop-blur-xs">
          ...
          <div className="lg:col-span-5 relative mt-4 lg:mt-0">
            <div className="bg-[#1A1A1A]/90 border border-[#E1E6EB]/15 p-4 sm:p-6 rounded-none space-y-4 sm:space-y-6 backdrop-blur-xs">
              {/* Mockup Header */}
              ...
              <div className="space-y-2.5 sm:space-y-3 font-mono text-xs text-[#9DA4B0]">
                <div className="p-2.5 sm:p-3 bg-[#111111]/90 border border-[#E1E6EB]/10 flex items-center justify-between gap-2">
              ...
              {/* Code Snippet Box */}
              <div className="p-3 sm:p-4 bg-[#0D0D0D]/90 border border-[#E1E6EB]/10 text-xs font-mono text-[#9DA4B0] space-y-1 overflow-x-auto">
