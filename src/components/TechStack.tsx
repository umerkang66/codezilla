    ...
    <section id="tech-stack" className="py-12 sm:py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4">
        {filteredItems.map((item, idx) => (
          <div
            key={idx}
            className="p-4 sm:p-5 bg-[#1A1A1A] border border-[#E1E6EB]/10 card-hover-effect group text-left rounded-xl"
          >
            <div className="w-9 h-9 sm:w-10 sm:h-10 bg-[#111111] border border-[#E1E6EB]/15 flex items-center justify-center text-[#81D607] group-hover:border-[#81D607] group-hover:scale-110 group-hover:bg-[#81D607]/10 transition-all duration-300 mb-3 sm:mb-4 rounded-lg">
